#ifndef ENCODE_VIDEO_OUTPUT_H264_TEST_H_H_
#define ENCODE_VIDEO_OUTPUT_H264_TEST_H_H_
#include "global.h"
#include <cstdio>
#include <stdlib.h>
#include <unistd.h>
...
int encode_video_output_h264_test(){

    FILE* rFile = fopen("./akiyo_cif.yuv","rb");
	if(rFile == NULL)
		return -1;
	const char * oFileName = "./test.h264";
    ...
    InitVideoAVCodecCtx(pCodecCtx, AV_CODEC_ID_H264, width, height);
